            ...
            <div className="flex flex-col gap-6">
              ...
              {activeTab === "social" && (
                <div className="flex flex-col gap-4">
                  <div className="rounded-xl border border-blue-200/70 bg-blue-50/60 p-3 text-xs leading-relaxed text-blue-700 dark:border-blue-900/60 dark:bg-blue-950/20 dark:text-blue-300">
                    除下面的常用链接外，关于页的社交项支持扩展图标：填写
                    `social:github`、`lucide:MessageCircle`、`simple:gitlab`，或直接填写
                    SVG/PNG 地址。可选图标库：Simple Icons 与 Lucide。
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-zinc-600 dark:text-zinc-300">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateSetting("github", e.target.value)
                        }
                      />
                    </div>
                    <div className="flex flex-col gap-1.5">
