    ...
    <div className="relative transform scale-75 xl:scale-100 origin-bottom" style={{ width: '450px', height: '350px' }}>
      ...
      <div 
        ...
        style={{
          left: '50px',
          width: '160px',
          height: (isTyping || isHidingPassword) ? '380px' : '350px',
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            top: (passwordLength > 0 && showPassword) ? `75px` : `${80 + (orangePos.faceY || 0)}px`,
          }}
        >
          <Pupil size={14} maxDistance={6} pupilColor="#2D2D2D" forceLookX={(passwordLength > 0 && showPassword) ? -5 : undefined} forceLookY={(passwordLength > 0 && showPassword) ? -4 : undefined} />
          <Pupil size={14} maxDistance={6} pupilColor="#2D2D2D" forceLookX={(passwordLength > 0 && showPassword) ? -5 : undefined} forceLookY={(passwordLength > 0 && showPassword) ? -4 : undefined} />
        </div>
      </div>
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            top: (passwordLength > 0 && showPassword) ? `80px` : `${80 + (yellowPos.faceY || 0)}px`,
          }}
        />
      </div>
    </div>
