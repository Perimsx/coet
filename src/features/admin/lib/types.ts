...
export type PostRevision = { id: string; postId: string; title: string; slug: string; summary: string; content: string; coverUrl: string; language: 'zh' | 'en'; categoryId?: string; seoTitle: string; seoDescription: string; createdAt: string }
