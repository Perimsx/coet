...
export default function HeaderClient({
  ...
  const morphBgClasses = isScrolled
    ...
    : 'w-[calc(100%-2rem)] max-w-[720px] h-14 sm:h-14 mt-3 sm:mt-5 rounded-full border border-border/20 dark:border-white/10 bg-background/60 dark:bg-background/20 backdrop-blur-2xl shadow-[0_8px_32px_-6px_rgba(0,0,0,0.06),inset_0_1px_1px_rgba(255,255,255,0.4)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_20px_40px_-12px_rgba(0,0,0,0.3)]'
